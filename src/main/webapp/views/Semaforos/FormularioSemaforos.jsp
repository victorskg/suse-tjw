...
<div class="wrapper fadeInDown">
    <div id="formContent">
        <h2 class="active"> ${not empty semaforo ? "Atualizar" : "Cadastrar"} Semáforo </h2>
        <form action="semaforos" method="post" autocomplete="off">
            <input type="hidden" id="id" class="fadeIn second"
                   name="id" value="${semaforo.id}" placeholder="id" autocomplete="off"/>
            <input type="text" id="codigo" class="fadeIn second"
                   name="codigo" value="${semaforo.codigo}" placeholder="Código" autocomplete="off"/>
            <input type="text" id="estado" class="fadeIn second"
                   name="estado" value="${semaforo.endereco.estado}" placeholder="Estado" autocomplete="off"/>
            <input type="text" id="cidade" class="fadeIn second"
                   name="cidade" value="${semaforo.endereco.cidade}" placeholder="Cidade" autocomplete="off"/>
            <input type="text" id="bairro" class="fadeIn second"
